...
import CustomerHomeNavbar from "./CustomerHomeNavbar";
...
const GradientButton = styled(MuiButton)(({ theme }) => ({
  ...
  fontWeight: "bold",
  "&:hover": {
    background: "linear-gradient(45deg, #C33764 40%, #1D2671 80%)",
  },
}));
              ...
              <div>
                <Card className="collaborator-card">
                  ...
                  <Card.Body>
                    ...
                    <Card.Text>
                      Providing expert support and services for our gas
                      connection system.
                    </Card.Text>
                  </Card.Body>
                </Card>
